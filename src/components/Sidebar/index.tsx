  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <span className="text-4xl text-white"> PumpMAster </span>
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-4">
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-4">
                          <li>
                            <NavLink
                              to="/home"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md p-2 bg-slate-100 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ' +
                                (isActive && 'text-black')
                              }
                            >
                              Home
              ...
              <SidebarLinkGroup
                // activeCondition={
                //   pathname === '/batch' || pathname.includes('dashboard')
                // }
                activeCondition={
                  pathname === '/pump-summary' ||
                  pathname === '/cash-book'
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-4">
                          <li>
                            <NavLink
                              to="/pump-summary"
                              className={({ isActive }) =>
                                `group relative flex items-center gap-2.5 rounded-md p-2 font-medium duration-300 ease-in-out ${
                                  isActive
                                    ? 'bg-slate-100 text-bodydark2 hover:text-black text-black'
                                    : 'text-bodydark2 hover:bg-slate-100 hover:text-black'
                                }`
                              }
                            >
                              Pump / Shift / Summary
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/credit/sales' ||
                  pathname === '/creditor' ||
                  pathname === '/creditor/add' ||
                  pathname === '/credit/sales/add'
                }
                // activeCondition={
                //   pathname === '/tank' || pathname.startsWith('/tank/')
                // }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname === '/creditor' && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/discount' || pathname === '/discount/add'
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname === '/discount' && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/tank' ||
                  pathname === '/meter' ||
                  pathname === '/tank-dipping' ||
                  pathname === '/fuel-offload'
                }
                // activeCondition={
                //   pathname === '/tank' || pathname.startsWith('/tank/')
                // }
                  ...
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          pathname === '/tank' && 'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/staff' || pathname === '/staff/add'
                }
                // activeCondition={
                //   pathname === '/tank' || pathname.startsWith('/tank/')
                // }
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === '/expenses' || pathname === '/expenses/add'
                }
                // activeCondition={
                //   pathname === '/tank' || pathname.startsWith('/tank/')
                // }
