...
//   'dipping/fetch',
//   async (_, thunkAPI) => {
//     const url = `${config.appUrl}/api/dipping`;
//     try {
//       const response = await fetchWithTokenRefresh(url);
//       if (!response.ok) {
//         // If the response is not ok, throw an error with the response message
...
export const TankSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    // handleAsyncThunk<TankState, fuelDelivery[], void>(builder, fetchFuelDelivery, {
    //   dataKey: 'fuelDelivery',
    //   loadingKey: 'Loading',
    //   errorKey: 'error',
    // });
    // // Handle addProduct
    // handleAsyncThunk<TankState, fuelDelivery, fuelDelivery>(builder, addFuelDelivery, {
    //   dataKey: 'fuelDelivery',
    //   loadingKey: 'Loading',
    //   errorKey: 'error',
    //   append: true,
