...
import { AuthActions, AuthSlice } from '../../store/Slice/Auth';
...
const SuccessMessage: React.FC<SuccessMessage> = ({ onClose, redirect }) => {
  return (
    <div className="w-full p-5 flex flex-col dark:bg-boxdark border">
      ...
      <div className="flex m-2 justify-end items-end">
        <button
          ...
          className="p-2 text-indigo-800 font-extrabold border"
        >
          {' '}
          OK{' '}
        </button>
  ...
  const submitForm = async (e: any) => {
    ...
    try {
      const response = await fetch(
        `${config.appUrl}/api/account/user/create/`,
        {
          method: 'POST',
      ...
      if (!response.ok) throw data; // Throw the parsed object, which includes errors
  ...
  return (
    ...
    <>
      <div className="flex flex-col h-screen justify-center">
        <div className="rounded-sm border max-w-7xl mx-auto border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form onSubmit={submitForm}>
                  <div className="mb-4">
                    ...
                    <div className="relative">
                      ...
                      <p className=" text-red-500 font-black p-2">
                        {' '}
                        {errors.email}{' '}
                      </p>
                    </div>
